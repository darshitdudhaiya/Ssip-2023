...
const ShowCaseDetail = ({isLoggedIn}) => {
      ...
      <div className="flex justify-center py-6 min-h-screen h-full md:mx-4">
        <div className="relative rounded-xl shadow-lg p-3 w-screen mx-3 md:mx-0 border border-black bg-white ">
            ...
            <div className="w-full md:w-full bg-white flex flex-col space-y-2 p-3">
              ...
              <div className="md:flex justify-between item-center">
                <div className="flex items-center mb-1">
                  <p className="text-gray-500 text-xs font-medium">Case number:<span className="text-gray-600 font-bold text-sm">125202</span></p>
                </div>
                <div className="flex items-center mb-1">
                  <p className="text-gray-500 text-xs font-medium">
                    Date file:
                    <span className="text-gray-600 font-bold text-sm">23 Oct 2023</span>
                  </p>
                </div>
                <div className="flex items-center mb-1">
                  <p className="text-gray-500 text-xs font-medium">
                    Case type:
                    <span className="text-gray-600 font-bold text-sm">Criminal</span>
                  </p>
                </div>
          ...
          <div className="xl:flex w-full gap-x-2">
            ...
            <div className="w-full">
              <CasesTable HearingDetail={HearingDetail} isLoggedIn={isLoggedIn} tableName={"Hearing"} />
            </div>
            {/* Evidence table section */}
            <div className="w-full mt-2 xl:mt-0">
              <CasesTable Evidence={Evidence} isLoggedIn={isLoggedIn} tableName={"Evidence"}  />
            </div>
          </div>
        </div>
      </div>
