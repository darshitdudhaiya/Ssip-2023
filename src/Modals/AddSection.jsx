...
function AddSections({ isOpen, onClose ,editAddSection}) {
    const [form, setForm] = useState({
      ...
      const [updateform, setUpdateForm] = useState({
        ...
        name: editAddSection ? (editAddSection.name ? editAddSection.name : "") : "",
        Description: editAddSection ? (editAddSection.description ? editAddSection.description : "") : "",
      });
      ...
      const handleSubmit = async (e) => {
        ...
        if (e.target.textContent === "Add") {
          ...
          const res = await addSections(form);
          console.log(res);
                        ...
                        <div className="h-full relative rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                            <div>
                                <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                    <label htmlFor="state" className="block font-semibold mb-2">Sections Name:</label>
                                    <input
                                ...
                                <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                    <label htmlFor="state" className="block font-semibold mb-2">Sections description:</label>
                                    <input
