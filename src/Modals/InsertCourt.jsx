...
const allStates = ['Andhra Pradesh', 'Arunachal Pradesh', 'Assam', /* ... add all states */];
const districtData = ['Andhra Pradesh', 'Arunachal Pradesh', 'Assam',];
function InsertCourt({ isOpen, onClose }) {
                    ...
                    <div className="h-full relative rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                        <div>
                            <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                <label htmlFor="state" className="block font-semibold mb-2">Court Name:</label>
                                <input
                            ...
                            <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                <label htmlFor="state" className="block font-semibold mb-2">Select State:</label>
                                <select
                                    id="state"
                                    name='Statename'
                                    defaultValue={form.Statename}
                                    onChange={handleInputChange}
                                    className="pl-2 inputbox outline-none border-none text-gray-900 text-sm rounded-lg block w-full focus:outline-none focus:border-none"
                                >
                            ...
                            <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                <label htmlFor="district" className="block font-semibold mb-2">Select District:</label>
                                <select
                            ...
                            <div className="items-center justify-between p-4 rounded-t dark:border-gray-600">
                                <label htmlFor="district" className="block font-semibold mb-2">Address</label>
                                <input
